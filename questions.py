...
QUESTIONS = [
    ...
    {
        "question": "What time should visitors arrive at Halden Bay in August to avoid parking problems?",
        "expects": "before 10am",
    },
    {
    ...
    {
        "question": "What can happen to Kestrelford during snowy winter weather?",
        "expects": "cut off",
    },
]
